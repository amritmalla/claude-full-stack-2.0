...
- Use `assets/PRD.template.md` as the output structure for `PRD.md`.
...
- [ ] Step 10: Generate `PRD.md` from `assets/PRD.template.md`, then validate it against `references/prd-quality-rubric.md`. Revise until the checklist passes or explicitly note any unresolved gap.

## Outputs

- `PRD.md` containing: Problem, Why Now, Users, JTBD, Current Alternatives, Scope, Non-goals, Constraints, Assumptions, Risks, Distribution and Adoption, Success Metrics, and Open Questions.
