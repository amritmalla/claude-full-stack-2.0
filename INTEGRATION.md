...
[claude-mem](https://github.com/amritmalla/claude-mem) is a local-first MCP server
...
claude-mem index --embedder openai --reset    # 1536d

export VOYAGE_API_KEY=vy-...
claude-mem index --embedder voyage --reset    # 512d
```
...
The full mapping between claude-full-stack-2.0 workflow phases and claude-mem
tools lives in
